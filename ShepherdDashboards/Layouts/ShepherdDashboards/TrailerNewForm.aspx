...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrailerNewForm.aspx.cs" Inherits="CAS.SmartFactory.Shepherd.Dashboards.Layouts.ShepherdDashboards.TrailerNewForm" DynamicMasterPageFile="~masterurl/default.master" %>
...
<table border="0" cellspacing="0" cellpadding="0" class="ms-propertysheet">
    <wssuc:InputFormSection ID="InputFormSection1" Title="Registration number" Description="Please add trailer's registration number"
      runat="server">
      <template_description>Please add trailer's registration number</template_description>
    ...
    <wssuc:InputFormSection ID="InputFormSection3" Title="Comments" Description="Comment that will allow you to easily identify the trailer"
      runat="server">
      <template_description>Comment that will allow you to easily identify the trailer</template_description>
      <template_inputformcontrols>
				<tr valign="top">
					<td class="ms-authoringcontrols" width="10">&#160;</td>
					<td class="ms-authoringcontrols" colspan="2">

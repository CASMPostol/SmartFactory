...
SPMetal.exe /web:http://casmp/ /language:csharp /namespace:CAS.SmartFactory.Shepherd.Dashboards.Entities /parameters:Parameters.xml /code:..\Entities.cs| write-host
write-host "Done . "

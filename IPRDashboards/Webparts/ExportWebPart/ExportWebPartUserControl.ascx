...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ExportWebPartUserControl.ascx.cs" Inherits="CAS.SmartFactory.IPR.Dashboards.Webparts.ExportWebPart.ExportWebPartUserControl" %>

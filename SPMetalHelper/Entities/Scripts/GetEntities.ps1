...
SPMetal.exe /web:http://casmp/sites/s42 /language:csharp /namespace:CAS.SmartFactory.SPMetalHelper.Entities /parameters:Parameters.xml /code:..\Entities.cs| write-host
write-host "Done . "

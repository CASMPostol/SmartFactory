...
namespace CAS.SmartFactory.Shepherd.RouteEditor.UpdateData
{
  ...
  internal partial class EntitiesDataContext: DataContext
  {
  ...
  /// <summary>
  /// Content type listy dystrybucyjnej
  /// </summary>
  ...
  /// <summary>
  /// Content type listy Opis ładunku
  /// </summary>
  ...
  /// <summary>
  /// Content type biblioteki Zlecenia spedycyjne
  /// </summary>

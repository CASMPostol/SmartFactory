...
namespace CAS.SmartFactory.Shepherd.Client.DataManagement.Tests
{
  ...
  public class StorageInfoComparisonTests
  {
    ...
    public void StorageInfoComparisonTestMethod()
    {
      ...
      Synchronizer.CompareSelectedStoragesContent<Linq.EscortPO, Linq2SQL.EscortPOLibrary>(Linq.EscortPO.GetMappings());
      Synchronizer.CompareSelectedStoragesContent<Linq.FreightPayer, Linq2SQL.FreightPayer>(Linq.FreightPayer.GetMappings());
      Synchronizer.CompareSelectedStoragesContent<Linq.FreightPO, Linq2SQL.FreightPOLibrary>(Linq.FreightPO.GetMappings());
      ...
      Synchronizer.CompareSelectedStoragesContent<Linq.SealProtocol, Linq2SQL.SealProtocolLibrary>(Linq.SealProtocol.GetMappings());

...
SPMetal.exe /web:http://casmp/sites/I80 /language:csharp /namespace:CAS.SmartFactory.CW.WebsiteModel.Linq /parameters:Parameters.xml /code:..\Entities.cs| write-host
write-host "Done . "
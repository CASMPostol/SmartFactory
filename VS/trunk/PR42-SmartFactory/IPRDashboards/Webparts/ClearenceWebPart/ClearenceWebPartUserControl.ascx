...
<asp:Panel ID="m_Panel" runat="server">
    <asp:Table runat="server" ID="m_MainWebPartTable" CssClass="Table">
        <asp:TableRow>
            <asp:TableCell>
                <asp:Panel ID="m_PainPanel" runat="server" GroupingText="<%$Resources:CASSmartFactoryIPR,CAS_ASPX_ClearanceManager%>" BorderColor="ActiveCaptionText">

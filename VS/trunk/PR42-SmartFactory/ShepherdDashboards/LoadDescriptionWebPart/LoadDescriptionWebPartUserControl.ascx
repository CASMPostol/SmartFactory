...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LoadDescriptionWebPartUserControl.ascx.cs" Inherits="CAS.SmartFactory.Shepherd.Dashboards.LoadDescriptionWebPart.LoadDescriptionWebPartUserControl" %>

  ...
  public partial class LoadDescriptionWebPartUserControl : UserControl
  {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      if (!IsPostBack)
      {
        ...
        m_LoadDescriptionGridView.Columns.Add(new BoundField() { DataField = "DeliveryNumber", Visible = true, HeaderText = "DeliveryNumber" });
    ...
    private void InitLoadDescriptionGridView(Shipping _sppng)
    {
      m_LoadDescriptionGridView.DataSource = from _ldidx in _sppng.LoadDescription
                                             select new { Title = _ldidx.Tytuł, DeliveryNumber = _ldidx.DeliveryNumber, ID = _ldidx.Identyfikator.Value };

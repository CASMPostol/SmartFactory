...
CREATE TABLE Clearence (
      ...
      CONSTRAINT FK_Clearence_SADGood FOREIGN KEY (Clearence2SadGoodID) REFERENCES SADGood (ID),
      CONSTRAINT FK_Clearence_SADConsignment FOREIGN KEY (SADConsignmentLibraryIndex) REFERENCES SADConsignment (ID),
);
...
CREATE TABLE IPR (
      ...
      CONSTRAINT FK_IPR_Clearence FOREIGN KEY (ClearenceIndex) REFERENCES Clearence (ID),
      CONSTRAINT FK_IPR_Consent FOREIGN KEY (IPR2ConsentTitle) REFERENCES Consent (ID),
      CONSTRAINT FK_IPR_JSOXLibrary FOREIGN KEY (IPR2JSOXIndex) REFERENCES JSOXLibrary (ID),
...
CREATE TABLE BalanceIPR (
      ...
      CONSTRAINT FK_BalanceIPR_BalanceBatch FOREIGN KEY (BalanceBatchIndex) REFERENCES BalanceBatch (ID),
      CONSTRAINT FK_BalanceIPR_JSOXLibrary FOREIGN KEY (BalanceIPR2JSOXIndex) REFERENCES JSOXLibrary (ID),
      CONSTRAINT FK_BalanceIPR_IPR FOREIGN KEY (IPRIndex) REFERENCES IPR (ID),
);
...
CREATE TABLE Disposal (
      ...
      CONSTRAINT FK_Disposal_Batch FOREIGN KEY (Disposal2BatchIndex) REFERENCES Batch (ID),
      CONSTRAINT FK_Disposal_Clearence FOREIGN KEY (Disposal2ClearenceIndex) REFERENCES Clearence (ID),
      CONSTRAINT FK_Disposal_InvoiceContent FOREIGN KEY (Disposal2InvoiceContentIndex) REFERENCES InvoiceContent (ID),
      CONSTRAINT FK_Disposal_IPR FOREIGN KEY (Disposal2IPRIndex) REFERENCES IPR (ID),
      CONSTRAINT FK_Disposal_Material FOREIGN KEY (Disposal2MaterialIndex) REFERENCES Material (ID),
      CONSTRAINT FK_Disposal_PCNCode FOREIGN KEY (Disposal2PCNID) REFERENCES PCNCode (ID),
      CONSTRAINT FK_Disposal_JSOXCustomsSummary FOREIGN KEY (JSOXCustomsSummaryIndex) REFERENCES JSOXCustomsSummary (ID),
);
CREATE TABLE Dust (
      Created datetime NOT NULL,
      CreatedBy nvarchar(255) NOT NULL,
...
CREATE TABLE StockEntry (
      ...
      CONSTRAINT FK_StockEntry_Batch FOREIGN KEY (BatchIndex) REFERENCES Batch (ID),
      CONSTRAINT FK_StockEntry_StockLibrary FOREIGN KEY (StockLibraryIndex) REFERENCES StockLibrary (ID),
);
CREATE TABLE Usage (
      Created datetime NOT NULL,
      CreatedBy nvarchar(255) NOT NULL,

  ...
  public class EntitiesDataDictionary : IDisposable
  {
    ...
    internal void AddRoute(PreliminaryDataRouteRoute _route, bool _testData)
    {
      ...
      try
      {
        ...
        ShipmentTypeShipmentType _ShipmentType = GetOrAdd<ShipmentTypeShipmentType>(m_EDC.ShipmentType, m_ShipmentType, _route.ShipmentType, false);
        CarrierCarrierType _CarrierCarrierType = GetOrAdd<CarrierCarrierType>(m_EDC.Carrier, m_CarrierCarrierType, _route.Carrier, false);
        ...
        SAPDestinationPlantSAPDestinationPlant _SAPDestinationPlant = GetOrAdd<SAPDestinationPlantSAPDestinationPlant>(m_EDC.SAPDestinationPlant, m_SAPDestinationPlant, _route.SAP_Dest_Plant, false);
        ...
        CommodityCommodity _cmdty = GetOrAdd<CommodityCommodity>(m_EDC.Commodity, m_CommodityCommodity, _route.Commodity, false);
    ...
    internal void AddMarket(PreliminaryDataRouteMarket _market)
    {
      try
      {
        MarketMarket _mrkt = GetOrAdd<MarketMarket>(m_EDC.Market, m_MarketMarket, _market.Market, false);

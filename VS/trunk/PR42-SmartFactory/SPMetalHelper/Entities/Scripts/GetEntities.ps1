...
SPMetal.exe /web:http://casmp/sites/s42 /language:csharp /namespace:CAS.SmartFactory.Shepherd.Entities /parameters:Parameters.xml /code:..\Entities.cs| write-host
write-host "Done . "

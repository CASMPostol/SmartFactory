...
namespace CAS.SmartFactory.xml.DocumentsFactory.CigaretteExportForm
{
  ...
  public partial class CigaretteExportForm
  {
    ...
    public string FinishedGoodBatch { get; set; }
    public double FinishedGoodQantity { get; set; }
    public string FinishedGoodUnit { get; set; }
    public string FamilyDescription { get; set; }
    public string BrandDescription { get; set; }
    public double MaterialTotal { get; set; }
    public string FinishedGoodSKUDescription { get; set; }
    public double TobaccoTotal { get; set; }
    public double IPTMaterialQuantityTotal { get; set; }
    public double IPTMaterialValueTotal { get; set; }
    public double IPTMaterialDutyTotal { get; set; }
    public double IPTMaterialVATTotal { get; set; }
    public double RegularMaterialQuantityTotal { get; set; }
    public double CTFUsageMin { get; set; }
    public double CTFUsageMax { get; set; }
    public double CTFUsagePerUnitMin { get; set; }
    public double CTFUsagePerUnitMaxn { get; set; }
    public double CTFUsagePer1MFinishedGoodsMin { get; set; }
    public double CTFUsagePer1MFinishedGoodsMax { get; set; }

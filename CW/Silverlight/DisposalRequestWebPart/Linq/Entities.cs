...
namespace CAS.SmartFactory.CW.Dashboards.DisposalRequestWebPart.Linq {
  ...
  public partial class CustomsWarehouse : Element {
    ...
    public System.Nullable<bool> _resourcesCASSmartFactoryIPRCAS_AccountClosed;
    
    public System.Nullable<bool> _resourcesCASSmartFactoryIPRCAS_Archival;
    ...
    [ColumnAttribute(Name="AccountClosed", Storage="_resourcesCASSmartFactoryIPRCAS_AccountClosed", Required=true, FieldType="Boolean")]
    public System.Nullable<bool> ResourcesCASSmartFactoryIPRCAS_AccountClosed {
      get {
        return this._resourcesCASSmartFactoryIPRCAS_AccountClosed;
      }
      set {
        if ((value != this._resourcesCASSmartFactoryIPRCAS_AccountClosed)) {
          this.OnPropertyChanging("ResourcesCASSmartFactoryIPRCAS_AccountClosed", this._resourcesCASSmartFactoryIPRCAS_AccountClosed);
          this._resourcesCASSmartFactoryIPRCAS_AccountClosed = value;
          this.OnPropertyChanged("ResourcesCASSmartFactoryIPRCAS_AccountClosed");
        }
      }
    }
    
    [ColumnAttribute(Name="Archival", Storage="_resourcesCASSmartFactoryIPRCAS_Archival", FieldType="Boolean")]
    ...
    public void OnCustomsWarehouseDisposalChanging(object sender, System.EventArgs e) {
      this.OnPropertyChanging("CustomsWarehouseDisposal", this._customsWarehouseDisposal.Clone());
    }
    
    public void OnCustomsWarehouseDisposalChanged(object sender, System.EventArgs e) {
      this.OnPropertyChanged("CustomsWarehouseDisposal");
    }
    
    public void OnCustomsWarehouseDisposalSync(object sender, AssociationChangedEventArgs<CustomsWarehouseDisposal> e) {
  ...
  public partial class CustomsWarehouseDisposal : Element {
    ...
    public System.Nullable<ResourcesCASSmartFactoryIPRCAS_ClearingType> _resourcesCASSmartFactoryIPRCAS_ClearingType;
    ...
    [ColumnAttribute(Name="ClearingType", Storage="_resourcesCASSmartFactoryIPRCAS_ClearingType", FieldType="Choice")]
    public System.Nullable<ResourcesCASSmartFactoryIPRCAS_ClearingType> ResourcesCASSmartFactoryIPRCAS_ClearingType {
      get {
    ...
    public void OnCWL_CWDisposal2CustomsWarehouseIDChanging(object sender, System.EventArgs e) {
      this.OnPropertyChanging("CWL_CWDisposal2CustomsWarehouseID", this._cWL_CWDisposal2CustomsWarehouseID.Clone());
    }
    
    public void OnCWL_CWDisposal2CustomsWarehouseIDChanged(object sender, System.EventArgs e) {
      this.OnPropertyChanged("CWL_CWDisposal2CustomsWarehouseID");
    }
    
  }
  
  public enum ResourcesCASSmartFactoryIPRCAS_ClearingType : int {

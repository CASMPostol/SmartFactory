  ...
  <div id="Body" >
    <table border="0" width="100%">
        ...
        <tr>
            <td valign="top">
                        <WebPartPages:WebpartZone
                        ID="ExitSheetWebPart" runat="server"
...
<asp:Literal ID="m_PageTitle" runat="server" Text="Exit Sheet" />
</asp:Content>

<asp:Content ID="PageTitleInTitleArea" ContentPlaceHolderID="PlaceHolderPageTitleInTitleArea" runat="server" >
<asp:Literal ID="m_PageTitleInTitleArea" runat="server" Text="Exit Sheet" />
</asp:Content>
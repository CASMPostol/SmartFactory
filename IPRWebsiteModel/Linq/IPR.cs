...
namespace CAS.SmartFactory.IPR.WebsiteModel.Linq
{
  public partial class IPR
  {
    ...
    internal void RecalculateClearedRecords( double startIndex )
    {
      ...
      List<Disposal> _2Calculate = ( from _dx in this.Disposal where _dx.CustomsStatus.Value == Linq.CustomsStatus.Started orderby _dx.No.Value ascending select _dx ).ToList<Disposal>();
